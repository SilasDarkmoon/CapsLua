...
namespace Capstones.LuaLib
{
    ...
    {
        public static void PushLua(this IntPtr l, LuaWrap.LuaOnStackFunc val)
        {
            l.pushvalue(val.StackPos);
        }
        public static void PushLua(this IntPtr l, LuaWrap.LuaFunc val)
        {
            l.getref(val.Refid);
        }
        ...
        private class LuaPushNative_LuaOnStackFunc : LuaPushNativeBase<LuaWrap.LuaOnStackFunc>
        {
            ...
            {
                return new LuaWrap.LuaOnStackFunc(l, index);
            }
            public override IntPtr PushLua(IntPtr l, LuaWrap.LuaOnStackFunc val)
            {
                l.pushvalue(val.StackPos);
                return IntPtr.Zero;
            }
        ...
        private class LuaPushNative_LuaFunc : LuaPushNativeBase<LuaWrap.LuaFunc>
        {
            public override LuaFunc GetLua(IntPtr l, int index)
            {
                return new LuaWrap.LuaFunc(l, index);
            }
            public override IntPtr PushLua(IntPtr l, LuaWrap.LuaFunc val)
            {
                l.getref(val.Refid);
                return IntPtr.Zero;
            }
