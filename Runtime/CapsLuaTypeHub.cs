        ...
        public class TypeHubBase : SelfHandled, ILuaTypeHub
        {
            ...
            public IntPtr PushLuaCommon(IntPtr l, object val)
            {
                ...
                if (LuaHub.LuaHubC.Ready)
                {
                    ...
                    LuaHub.LuaHubC.capslua_pushObject(l, h, r, ShouldCache);
                    return h;
                }
                else
#endif
            ...
            public virtual void SetData(IntPtr l, int index, object val)
            {
                ...
                if (LuaHub.LuaHubC.Ready)
                {
                    ...
                    LuaHub.LuaHubC.capslua_setObject(l, index, h);
                }
                else
#endif
                {
            ...
            public virtual object GetLua(IntPtr l, int index)
            {
                ...
                {
                    IntPtr h;
                    LuaHub.LuaHubC.capslua_getObject(l, index, out h);
                    try
                    {
            ...
            public void PushLuaTypeRaw(IntPtr l)
            {
                ...
                if (LuaHub.LuaHubC.Ready)
                {
                    LuaHub.LuaHubC.capslua_pushTypeIndex(l, 4);
                }
                else
#endif
                {
                ...
                if (LuaHub.LuaHubC.Ready)
                {
                    LuaHub.LuaHubC.capslua_pushTypeNewIndex(l, 2);
                }
                else
#endif
                {
                ...
                if (LuaHub.LuaHubC.Ready)
                {
                    LuaHub.LuaHubC.capslua_pushObjNewIndex(l, 3);
                }
                else
#endif
                {
                ...
                if (LuaHub.LuaHubC.Ready)
                {
                    LuaHub.LuaHubC.capslua_pushObjIndex(l, 3);
                }
                else
#endif
                {
                ...
                if (t != null && t.IsSubclassOf(typeof(Delegate)))
                {
                    if (_InstanceMethods.ContainsKey("Invoke"))
                    {
                        ...
                        CapsLuaDelegateGenerator.PushDelegateInvokeMeta(l);
                        l.rawset(-3);
                    }
                }
                // ext-type
