...
namespace Capstones.LuaLib
{
    ...
    {
        public class TypeHubPrecompiled_System_Double : Capstones.LuaLib.LuaTypeHub.TypeHubValueTypePrecompiled<System.Double>, ILuaNative, ILuaConvert
        {
            public TypeHubPrecompiled_System_Double()
            {
                #region REG_I_FUNC
            ...
            public override void RegPrecompiledStatic()
            {
                ...
                #region REG_S_FUNC
                _StaticMethods["IsInfinity"] = new LuaMetaCallWithPrecompiled() { _Method = _StaticMethods["IsInfinity"]._Method, _Precompiled = ___sfm_IsInfinity };
                _StaticMethods["IsNaN"] = new LuaMetaCallWithPrecompiled() { _Method = _StaticMethods["IsNaN"]._Method, _Precompiled = ___sfm_IsNaN };
                _StaticMethods["IsNegativeInfinity"] = new LuaMetaCallWithPrecompiled() { _Method = _StaticMethods["IsNegativeInfinity"]._Method, _Precompiled = ___sfm_IsNegativeInfinity };
                _StaticMethods["IsPositiveInfinity"] = new LuaMetaCallWithPrecompiled() { _Method = _StaticMethods["IsPositiveInfinity"]._Method, _Precompiled = ___sfm_IsPositiveInfinity };
                ...
                #region REG_S_PROP
                _StaticFieldsIndex["Epsilon"] = new LuaMetaCallWithPrecompiled() { _Method = _StaticFieldsIndex["Epsilon"]._Method, _Precompiled = ___sgf_Epsilon };
                ...
                _StaticFieldsIndex["NaN"] = new LuaMetaCallWithPrecompiled() { _Method = _StaticFieldsIndex["NaN"]._Method, _Precompiled = ___sgf_NaN };
                _StaticFieldsIndex["NegativeInfinity"] = new LuaMetaCallWithPrecompiled() { _Method = _StaticFieldsIndex["NegativeInfinity"]._Method, _Precompiled = ___sgf_NegativeInfinity };
                _StaticFieldsIndex["PositiveInfinity"] = new LuaMetaCallWithPrecompiled() { _Method = _StaticFieldsIndex["PositiveInfinity"]._Method, _Precompiled = ___sgf_PositiveInfinity };
            ...
            #region DEL_S_FUNC
            private static readonly lua.CFunction ___sfm_IsInfinity = new lua.CFunction(___smm_IsInfinity);
            private static readonly lua.CFunction ___sfm_IsNaN = new lua.CFunction(___smm_IsNaN);
            private static readonly lua.CFunction ___sfm_IsNegativeInfinity = new lua.CFunction(___smm_IsNegativeInfinity);
            private static readonly lua.CFunction ___sfm_IsPositiveInfinity = new lua.CFunction(___smm_IsPositiveInfinity);
            ...
            #region DEL_S_PROP
            private static readonly lua.CFunction ___sgf_Epsilon = new lua.CFunction(___sgm_Epsilon);
            ...
            private static readonly lua.CFunction ___sgf_NaN = new lua.CFunction(___sgm_NaN);
            private static readonly lua.CFunction ___sgf_NegativeInfinity = new lua.CFunction(___sgm_NegativeInfinity);
            private static readonly lua.CFunction ___sgf_PositiveInfinity = new lua.CFunction(___sgm_PositiveInfinity);
            ...
            #region FUNC_S_FUNC
            [AOT.MonoPInvokeCallback(typeof(lua.CFunction))]
            private static int ___smm_IsInfinity(IntPtr l)
            {
                try
                {
                    System.Double p0;
                    l.GetLua(1, out p0);
                    var rv = System.Double.IsInfinity(p0);
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            [AOT.MonoPInvokeCallback(typeof(lua.CFunction))]
            private static int ___smm_IsNaN(IntPtr l)
            {
                try
                {
                    System.Double p0;
                    l.GetLua(1, out p0);
                    var rv = System.Double.IsNaN(p0);
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            [AOT.MonoPInvokeCallback(typeof(lua.CFunction))]
            private static int ___smm_IsNegativeInfinity(IntPtr l)
            {
                try
                {
                    System.Double p0;
                    l.GetLua(1, out p0);
                    var rv = System.Double.IsNegativeInfinity(p0);
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            [AOT.MonoPInvokeCallback(typeof(lua.CFunction))]
            private static int ___smm_IsPositiveInfinity(IntPtr l)
            {
                try
                {
                    System.Double p0;
                    l.GetLua(1, out p0);
                    var rv = System.Double.IsPositiveInfinity(p0);
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
                ...
                {
                    {
                        ...
                        Label_20:
                        {
                            ...
                            System.IFormatProvider p1;
                            l.GetLua(2, out p1);
                            var rv = System.Double.Parse(p0, p1);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
                        Label_30:
                        {
                            ...
                            System.IFormatProvider p2;
                            l.GetLua(3, out p2);
                            var rv = System.Double.Parse(p0, p1, p2);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
                ...
                {
                    {
                        ...
                        Label_10:
                        {
                            ...
                            System.Double p3;
                            l.GetLua(4, out p3);
                            var rv = System.Double.TryParse(p0, p1, p2, out p3);
                            l.PushLua(rv);
                            l.PushLua(p3);
                            return 2;
                        }
                        ...
                        Label_20:
                        {
                            ...
                            System.Double p1;
                            l.GetLua(2, out p1);
                            var rv = System.Double.TryParse(p0, out p1);
                            l.PushLua(rv);
                            l.PushLua(p1);
                            return 2;
                        }
            ...
            #region FUNC_S_PROP
            [AOT.MonoPInvokeCallback(typeof(lua.CFunction))]
            private static int ___sgm_Epsilon(IntPtr l)
            {
                try
                {
                    var rv = System.Double.Epsilon;
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            [AOT.MonoPInvokeCallback(typeof(lua.CFunction))]
            private static int ___sgm_NaN(IntPtr l)
            {
                try
                {
                    var rv = System.Double.NaN;
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            [AOT.MonoPInvokeCallback(typeof(lua.CFunction))]
            private static int ___sgm_NegativeInfinity(IntPtr l)
            {
                try
                {
                    var rv = System.Double.NegativeInfinity;
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            [AOT.MonoPInvokeCallback(typeof(lua.CFunction))]
            private static int ___sgm_PositiveInfinity(IntPtr l)
            {
                try
                {
                    var rv = System.Double.PositiveInfinity;
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            {
                PushLua(l, (System.Double)val);
                return IntPtr.Zero;
            }
            public override void SetData(IntPtr l, int index, object val)
            {
                SetDataRaw(l, index, (System.Double)val);
            }
            ...
            public override IntPtr PushLua(IntPtr l, System.Double val)
            {
                l.checkstack(3);
                l.newtable(); // ud
                SetDataRaw(l, -1, val);
            ...
            public override void SetData(IntPtr l, int index, System.Double val)
            {
                SetDataRaw(l, index, val);
            }
            public override System.Double GetLua(IntPtr l, int index)
            {
                return GetLuaRaw(l, index);
            }
            ...
            public static void SetDataRaw(IntPtr l, int index, System.Double val)
            {
                l.checkstack(3);
            ...
            public static System.Double GetLuaRaw(IntPtr l, int index)
            {
                System.Double rv;
                l.checkstack(2);
                l.pushvalue(index); // otab
            ...
            public static System.Double GetLuaChecked(IntPtr l, int index)
            {
                if (l.istable(index))
                {
                    return GetLuaRaw(l, index);
        ...
        private static TypeHubPrecompiled_System_Double ___tp_System_Double = new TypeHubPrecompiled_System_Double();
    }
}
#endif
