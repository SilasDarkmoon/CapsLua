...
namespace Capstones.LuaLib
{
    ...
    {
        public class TypeHubPrecompiled_System_Single : Capstones.LuaLib.LuaTypeHub.TypeHubValueTypePrecompiled<System.Single>, ILuaNative, ILuaConvert
        {
            public TypeHubPrecompiled_System_Single()
            {
                #region REG_I_FUNC
            ...
            private static int ___smm_IsInfinity(IntPtr l)
            {
                try
                {
                    System.Single p0;
                    l.GetLua(1, out p0);
                    var rv = System.Single.IsInfinity(p0);
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            private static int ___smm_IsNegativeInfinity(IntPtr l)
            {
                try
                {
                    System.Single p0;
                    l.GetLua(1, out p0);
                    var rv = System.Single.IsNegativeInfinity(p0);
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            private static int ___smm_IsPositiveInfinity(IntPtr l)
            {
                try
                {
                    System.Single p0;
                    l.GetLua(1, out p0);
                    var rv = System.Single.IsPositiveInfinity(p0);
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
                ...
                {
                    {
                        ...
                        Label_20:
                        {
                            ...
                            System.IFormatProvider p1;
                            l.GetLua(2, out p1);
                            var rv = System.Single.Parse(p0, p1);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
            ...
            private static int ___sgm_PositiveInfinity(IntPtr l)
            {
                try
                {
                    var rv = System.Single.PositiveInfinity;
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            private static int ___sgm_NegativeInfinity(IntPtr l)
            {
                try
                {
                    var rv = System.Single.NegativeInfinity;
                    l.PushLua(rv);
                    return 1;
                }
                catch (Exception exception)
            ...
            {
                PushLua(l, (System.Single)val);
                return IntPtr.Zero;
            }
            public override void SetData(IntPtr l, int index, object val)
            {
                SetDataRaw(l, index, (System.Single)val);
            }
            ...
            public override IntPtr PushLua(IntPtr l, System.Single val)
            {
                l.checkstack(3);
                l.newtable(); // ud
                SetDataRaw(l, -1, val);
            ...
            public override void SetData(IntPtr l, int index, System.Single val)
            {
                SetDataRaw(l, index, val);
            }
            public override System.Single GetLua(IntPtr l, int index)
            {
                return GetLuaRaw(l, index);
            }
            ...
            public static void SetDataRaw(IntPtr l, int index, System.Single val)
            {
                l.checkstack(3);
            ...
            public static System.Single GetLuaRaw(IntPtr l, int index)
            {
                System.Single rv;
                l.checkstack(2);
                l.pushvalue(index); // otab
            ...
            public static System.Single GetLuaChecked(IntPtr l, int index)
            {
                if (l.istable(index))
                {
                    return GetLuaRaw(l, index);
        ...
        private static TypeHubPrecompiled_System_Single ___tp_System_Single = new TypeHubPrecompiled_System_Single();
    }
}
#endif
