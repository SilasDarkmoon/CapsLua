...
namespace Capstones.LuaLib
{
    ...
    {
        public class TypeHubPrecompiled_System_Int64 : Capstones.LuaLib.LuaTypeHub.TypeHubValueTypePrecompiled<System.Int64>, ILuaNative, ILuaConvert
        {
            public TypeHubPrecompiled_System_Int64()
            {
                #region REG_I_FUNC
                ...
                {
                    {
                        ...
                        Label_10:
                        {
                            ...
                            System.IFormatProvider p1;
                            l.GetLua(2, out p1);
                            var rv = System.Int64.Parse(p0, p1);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
                        ...
                        Label_30:
                        {
                            ...
                            System.IFormatProvider p2;
                            l.GetLua(3, out p2);
                            var rv = System.Int64.Parse(p0, p1, p2);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
                ...
                {
                    {
                        ...
                        Label_10:
                        {
                            ...
                            System.Int64 p1;
                            l.GetLua(2, out p1);
                            var rv = System.Int64.TryParse(p0, out p1);
                            l.PushLua(rv);
                            l.PushLua(p1);
                            return 2;
                        }
                        ...
                        Label_20:
                        {
                            ...
                            System.Int64 p3;
                            l.GetLua(4, out p3);
                            var rv = System.Int64.TryParse(p0, p1, p2, out p3);
                            l.PushLua(rv);
                            l.PushLua(p3);
                            return 2;
                        }
            ...
            {
                PushLua(l, (System.Int64)val);
                return IntPtr.Zero;
            }
            public override void SetData(IntPtr l, int index, object val)
            {
                SetDataRaw(l, index, (System.Int64)val);
            }
            ...
            public override IntPtr PushLua(IntPtr l, System.Int64 val)
            {
                l.checkstack(3);
                l.newtable(); // ud
                SetDataRaw(l, -1, val);
            ...
            public override void SetData(IntPtr l, int index, System.Int64 val)
            {
                SetDataRaw(l, index, val);
            }
            public override System.Int64 GetLua(IntPtr l, int index)
            {
                return GetLuaRaw(l, index);
            }
            ...
            public static void SetDataRaw(IntPtr l, int index, System.Int64 val)
            {
                l.checkstack(3);
            ...
            public static System.Int64 GetLuaRaw(IntPtr l, int index)
            {
                System.Int64 rv;
                l.checkstack(2);
                l.pushvalue(index); // otab
            ...
            public static System.Int64 GetLuaChecked(IntPtr l, int index)
            {
                if (l.istable(index))
                {
                    return GetLuaRaw(l, index);
        ...
        private static TypeHubPrecompiled_System_Int64 ___tp_System_Int64 = new TypeHubPrecompiled_System_Int64();
    }
}
#endif
