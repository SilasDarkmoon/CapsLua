...
namespace Capstones.LuaLib
{
    ...
    {
        public class TypeHubPrecompiled_UnityEngine_UI_Button : LuaHub.TypeHubPrecompiled_UnityEngine_UI_Selectable
        {
            public TypeHubPrecompiled_UnityEngine_UI_Button() : this(typeof(UnityEngine.UI.Button)) { }
            public TypeHubPrecompiled_UnityEngine_UI_Button(Type type) : base(type)
            {
                #region REG_I_FUNC
        ...
        private static TypeHubPrecompiled_UnityEngine_UI_Button ___tp_UnityEngine_UI_Button = new TypeHubPrecompiled_UnityEngine_UI_Button();
        public static void PushLua(this IntPtr l, UnityEngine.UI.Button val)
        {
        ...
        public static void GetLua(this IntPtr l, int index, out UnityEngine.UI.Button val)
        {
            val = LuaHub.GetLuaTableObjectChecked(l, index) as UnityEngine.UI.Button;
        }
    }
}
#endif
