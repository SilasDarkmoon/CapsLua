...
namespace Capstones.LuaLib
{
    ...
    {
        public class TypeHubPrecompiled_System_UInt64 : Capstones.LuaLib.LuaTypeHub.TypeHubValueTypePrecompiled<System.UInt64>, ILuaNative, ILuaConvert
        {
            public TypeHubPrecompiled_System_UInt64()
            {
                #region REG_I_FUNC
                ...
                {
                    {
                        ...
                        Label_10:
                        {
                            ...
                            System.IFormatProvider p1;
                            l.GetLua(2, out p1);
                            var rv = System.UInt64.Parse(p0, p1);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
                        Label_20:
                        {
                            ...
                            System.IFormatProvider p2;
                            l.GetLua(3, out p2);
                            var rv = System.UInt64.Parse(p0, p1, p2);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
            ...
            private static int ___smm_TryParse(IntPtr l)
            {
                try
                {
                    ...
                    System.UInt64 p1;
                    l.GetLua(2, out p1);
                    var rv = System.UInt64.TryParse(p0, out p1);
                    l.PushLua(rv);
                    l.PushLua(p1);
                    return 2;
                }
            ...
            {
                PushLua(l, (System.UInt64)val);
                return IntPtr.Zero;
            }
            public override void SetData(IntPtr l, int index, object val)
            {
                SetDataRaw(l, index, (System.UInt64)val);
            }
            ...
            public override IntPtr PushLua(IntPtr l, System.UInt64 val)
            {
                l.checkstack(3);
                l.newtable(); // ud
                SetDataRaw(l, -1, val);
            ...
            public override void SetData(IntPtr l, int index, System.UInt64 val)
            {
                SetDataRaw(l, index, val);
            }
            public override System.UInt64 GetLua(IntPtr l, int index)
            {
                return GetLuaRaw(l, index);
            }
            ...
            public static void SetDataRaw(IntPtr l, int index, System.UInt64 val)
            {
                l.checkstack(3);
            ...
            public static System.UInt64 GetLuaRaw(IntPtr l, int index)
            {
                System.UInt64 rv;
                l.checkstack(2);
                l.pushvalue(index); // otab
            ...
            public static System.UInt64 GetLuaChecked(IntPtr l, int index)
            {
                if (l.istable(index))
                {
                    return GetLuaRaw(l, index);
        ...
        private static TypeHubPrecompiled_System_UInt64 ___tp_System_UInt64 = new TypeHubPrecompiled_System_UInt64();
    }
}
#endif
