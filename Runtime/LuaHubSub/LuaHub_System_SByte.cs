...
namespace Capstones.LuaLib
{
    ...
    {
        public class TypeHubPrecompiled_System_SByte : Capstones.LuaLib.LuaTypeHub.TypeHubValueTypePrecompiled<System.SByte>, ILuaNative, ILuaConvert
        {
            public TypeHubPrecompiled_System_SByte()
            {
                #region REG_I_FUNC
                ...
                {
                    {
                        ...
                        Label_10:
                        {
                            ...
                            System.IFormatProvider p1;
                            l.GetLua(2, out p1);
                            var rv = System.SByte.Parse(p0, p1);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
                        Label_20:
                        {
                            ...
                            System.IFormatProvider p2;
                            l.GetLua(3, out p2);
                            var rv = System.SByte.Parse(p0, p1, p2);
                            l.PushLua(rv);
                            return 1;
                        }
                        goto Label_default;
            ...
            private static int ___smm_TryParse(IntPtr l)
            {
                try
                {
                    ...
                    System.SByte p1;
                    l.GetLua(2, out p1);
                    var rv = System.SByte.TryParse(p0, out p1);
                    l.PushLua(rv);
                    l.PushLua(p1);
                    return 2;
                }
            ...
            {
                PushLua(l, (System.SByte)val);
                return IntPtr.Zero;
            }
            public override void SetData(IntPtr l, int index, object val)
            {
                SetDataRaw(l, index, (System.SByte)val);
            }
            ...
            public override IntPtr PushLua(IntPtr l, System.SByte val)
            {
                l.checkstack(3);
                l.newtable(); // ud
                SetDataRaw(l, -1, val);
            ...
            public override void SetData(IntPtr l, int index, System.SByte val)
            {
                SetDataRaw(l, index, val);
            }
            public override System.SByte GetLua(IntPtr l, int index)
            {
                return GetLuaRaw(l, index);
            }
            ...
            public static void SetDataRaw(IntPtr l, int index, System.SByte val)
            {
                l.checkstack(3);
            ...
            public static System.SByte GetLuaRaw(IntPtr l, int index)
            {
                System.SByte rv;
                l.checkstack(2);
                l.pushvalue(index); // otab
            ...
            public static System.SByte GetLuaChecked(IntPtr l, int index)
            {
                if (l.istable(index))
                {
                    return GetLuaRaw(l, index);
        ...
        private static TypeHubPrecompiled_System_SByte ___tp_System_SByte = new TypeHubPrecompiled_System_SByte();
    }
}
#endif
