...
namespace Capstones.LuaLib
{
    ...
    {
        public static void PushLua(this IntPtr l, LuaWrap.LuaOnStackTable val)
        {
            l.pushvalue(val.StackPos);
        }
        public static void PushLua(this IntPtr l, LuaWrap.LuaTable val)
        {
            l.getref(val.Refid);
        }
        public static void PushLua(this IntPtr l, LuaWrap.LuaOnStackRawTable val)
        {
            l.pushvalue(val.StackPos);
        }
        public static void PushLua(this IntPtr l, LuaWrap.LuaRawTable val)
        {
            l.getref(val.Refid);
        }
        ...
        private class LuaPushNative_LuaOnStackTable : LuaPushNativeBase<LuaWrap.LuaOnStackTable>
        {
            ...
            public override IntPtr PushLua(IntPtr l, LuaWrap.LuaOnStackTable val)
            {
                l.pushvalue(val.StackPos);
                return IntPtr.Zero;
            }
        ...
        private class LuaPushNative_LuaTable : LuaPushNativeBase<LuaWrap.LuaTable>
        {
            public override LuaTable GetLua(IntPtr l, int index)
            {
                return new LuaTable(l, index);
            }
            public override IntPtr PushLua(IntPtr l, LuaWrap.LuaTable val)
            {
                l.getref(val.Refid);
                return IntPtr.Zero;
            }
        ...
        private class LuaPushNative_LuaOnStackRawTable : LuaPushNativeBase<LuaWrap.LuaOnStackRawTable>
        {
            public override LuaOnStackRawTable GetLua(IntPtr l, int index)
            {
                return new LuaOnStackRawTable(l, index);
            }
            public override IntPtr PushLua(IntPtr l, LuaWrap.LuaOnStackRawTable val)
            {
                l.pushvalue(val.StackPos);
                return IntPtr.Zero;
            }
        ...
        private class LuaPushNative_LuaRawTable : LuaPushNativeBase<LuaWrap.LuaRawTable>
        {
            public override LuaRawTable GetLua(IntPtr l, int index)
            {
                return new LuaRawTable(l, index);
            }
            public override IntPtr PushLua(IntPtr l, LuaWrap.LuaRawTable val)
            {
                l.getref(val.Refid);
                return IntPtr.Zero;
            }
