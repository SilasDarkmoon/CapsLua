...
#endif
{
    private class TypeHubPrecompiled_CapsUnityLuaBehav : Capstones.LuaLib.LuaTypeHub.TypeHubCommonPrecompiled
    {
        public TypeHubPrecompiled_CapsUnityLuaBehav()
            : base(typeof(CapsUnityLuaBehav))
        {
        }
    ...
    [NonSerialized] protected internal static Dictionary<int, CapsUnityLuaBehav> _DestroyReg = new Dictionary<int, CapsUnityLuaBehav>();
