...
#include <iostream>
#include "CapsLua.hpp"
#include "CapsLuaPriv.hpp"

//void CapsLua::HelloWorld(const char * s)
//{
//    CapsLuaPriv *theObj = new CapsLuaPriv;
//    theObj->HelloWorldPriv(s);
//    delete theObj;
//};
//
//void CapsLuaPriv::HelloWorldPriv(const char * s)
//{
//    std::cout << s << std::endl;
//};
...
extern "C"
{
int luaopen_CapsLua(void* l)
{
    //std::cout << "begin init CapsLua" << std::endl;
...
//    }
    ...
    //
    const string_t config_path = root_path + STR("CapsLuaStandalone.runtimeconfig.json");
    ...
    //
    const string_t dotnetlib_path = root_path + STR("CapsLuaStandalone.dll");
    const char_t *dotnet_type = STR("Capstones.UnityEngineEx.GlobalLua, CapsLuaStandalone");
    ...
    int rc = load_assembly_and_get_function_pointer(
        ...
        dotnet_type,
        STR("luaopen_CapsLua") /*method_name*/,
        STR("Capstones.LuaLib.LuaCoreLib+CFunction, CapsLuaStandalone") /*delegate_type_name*/,
        nullptr,
        (void**)&custom);
