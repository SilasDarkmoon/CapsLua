...
LUALIB_API int capslua_checkVer(int ver)
{
    if (ver != 7)
    {
        return 0;
...
LUALIB_API void capslua_setCSFuncs(
...
LUALIB_API void capslua_wrapFunctionByTable(lua_State *l, void* methodmeta)
{
    // rawfunc
    lua_checkstack(l, 5);
...
LUALIB_API void capslua_pushTypeIndex(lua_State *l, int n_upvalue)
{
...
LUALIB_API void capslua_pushTypeNewIndex(lua_State *l, int n_upvalue)
{
...
LUALIB_API void capslua_pushObjIndex(lua_State *l, int n_upvalue)
{
...
LUALIB_API void capslua_pushObjNewIndex(lua_State *l, int n_upvalue)
{
...
LUALIB_API void capslua_pushCommonBinaryOp(lua_State *l, int n_upvalue)
{
...
LUALIB_API void capslua_pushCommonEq(lua_State *l, int n_upvalue)
{
...
// push-objs
LUALIB_API void capslua_pushObject(lua_State *l, void* obj, void* type, int shouldcache)
{
    lua_checkstack(l, 6);
...
LUALIB_API void capslua_setObject(lua_State *l, int index, void* obj)
{
    lua_checkstack(l, 6);
...
LUALIB_API void capslua_getObject(lua_State *l, int index, void** obj)
{
    lua_checkstack(l, 2);
...
LUALIB_API void capslua_setTypeVector3(void* type)
{
    typeVector3 = type;
}
LUALIB_API void capslua_pushVector3(lua_State *l, float x, float y, float z)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setVector3(lua_State *l, int index, float x, float y, float z)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getVector3(lua_State *l, int index, float* x, float* y, float* z)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypeBounds(void* type)
{
    typeBounds = type;
}
LUALIB_API void capslua_pushBounds(lua_State *l, float center_x, float center_y, float center_z, float extents_x, float extents_y, float extents_z)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setBounds(lua_State *l, int index, float center_x, float center_y, float center_z, float extents_x, float extents_y, float extents_z)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getBounds(lua_State *l, int index, float* center_x, float* center_y, float* center_z, float* extents_x, float* extents_y, float* extents_z)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypeLayerMask(void* type)
{
    typeLayerMask = type;
}
LUALIB_API void capslua_pushLayerMask(lua_State *l, int value)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setLayerMask(lua_State *l, int index, int value)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getLayerMask(lua_State *l, int index, int* value)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypePlane(void* type)
{
    typePlane = type;
}
LUALIB_API void capslua_pushPlane(lua_State *l, float distance, float normal_x, float normal_y, float normal_z)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setPlane(lua_State *l, int index, float distance, float normal_x, float normal_y, float normal_z)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getPlane(lua_State *l, int index, float* distance, float* normal_x, float* normal_y, float* normal_z)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypeQuaternion(void* type)
{
    typeQuaternion = type;
}
LUALIB_API void capslua_pushQuaternion(lua_State *l, float x, float y, float z, float w)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setQuaternion(lua_State *l, int index, float x, float y, float z, float w)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getQuaternion(lua_State *l, int index, float* x, float* y, float* z, float* w)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypeColor(void* type)
{
    typeColor = type;
}
LUALIB_API void capslua_pushColor(lua_State *l, float r, float g, float b, float a)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setColor(lua_State *l, int index, float r, float g, float b, float a)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getColor(lua_State *l, int index, float* r, float* g, float* b, float* a)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypeRay(void* type)
{
    typeRay = type;
}
LUALIB_API void capslua_pushRay(lua_State *l, float origin_x, float origin_y, float origin_z, float direction_x, float direction_y, float direction_z)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setRay(lua_State *l, int index, float origin_x, float origin_y, float origin_z, float direction_x, float direction_y, float direction_z)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getRay(lua_State *l, int index, float* origin_x, float* origin_y, float* origin_z, float* direction_x, float* direction_y, float* direction_z)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypeRect(void* type)
{
    typeRect = type;
}
LUALIB_API void capslua_pushRect(lua_State *l, float xMin, float yMin, float width, float height)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setRect(lua_State *l, int index, float xMin, float yMin, float width, float height)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getRect(lua_State *l, int index, float* xMin, float* yMin, float* width, float* height)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypeVector2(void* type)
{
    typeVector2 = type;
}
LUALIB_API void capslua_pushVector2(lua_State *l, float x, float y)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setVector2(lua_State *l, int index, float x, float y)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getVector2(lua_State *l, int index, float* x, float* y)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_setTypeVector4(void* type)
{
    typeVector4 = type;
}
LUALIB_API void capslua_pushVector4(lua_State *l, float x, float y, float z, float w)
{
    lua_checkstack(l, 3);
...
LUALIB_API void capslua_setVector4(lua_State *l, int index, float x, float y, float z, float w)
{
    lua_checkstack(l, 1);
...
LUALIB_API void capslua_getVector4(lua_State *l, int index, float* x, float* y, float* z, float* w)
{
    lua_checkstack(l, 1);
